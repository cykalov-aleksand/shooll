...
public class StudentControllerTest {
    ...
    public void createStudentTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                //анализ данных полученных в ответ на запрос
    ...
    public void editStudentTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        ...
                        .accept(MediaType.APPLICATION_JSON))
                .andDo(print())
                //анализ статуса ответа на запрос
                .andExpect(status().isOk())
                //анализ данных полученных при запросе
    ...
    public void getStudentInfoTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        ...
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                //анализ количества принятых данных в результате тестового запроса
    ...
    public void getStudentInfoTest1() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        ...
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                //анализ количества принятых данных по результату запроса
    ...
    public void getStudentInfoIdTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                //анализ статуса ответа на запрос
                .andExpect(status().isOk())
                //анализ принятых данных после проведения запроса по 0 элементу
                .andExpect(jsonPath("$.id").value(students.get(0).getId()))
                .andExpect(jsonPath("$.name").value(students.get(0).getName()))
                .andExpect(jsonPath("$.age").value(students.get(0).getAge()));
    }
